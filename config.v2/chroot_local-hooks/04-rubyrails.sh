...
echo '[[ -s "$HOME/.rvm/scripts/rvm" ]] && source "$HOME/.rvm/scripts/rvm"' >> /home/${GS_USER}/.bashrc

echo -e "GBE: Disable ri and rdoc generation ...\n"
echo "gem: --no-ri --no-rdoc" > /home/${GS_USER}/.gemrc
chown ${GS_USER}.${GS_GROUP} /home/${GS_USER}/.gemrc
